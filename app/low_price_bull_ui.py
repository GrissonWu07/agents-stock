...
from app.selector_ui_state import load_simple_selector_state, save_simple_selector_state
from app.batch_deep_analysis import display_batch_deep_analysis_section
from app.low_price_bull_selector import LowPriceBullSelector
from app.low_price_bull_strategy import LowPriceBullStrategy
from app.notification_service import notification_service
from app.low_price_bull_monitor import low_price_bull_monitor
from app.low_price_bull_service import low_price_bull_service
from app.watchlist_selector_integration import add_stock_to_watchlist, sync_selector_dataframe_to_watchlist
...
def display_low_price_bull():
    ...
    if st.session_state.get('show_low_price_monitor'):
        from app.low_price_bull_monitor_ui import display_monitor_panel
...
def display_stock_detail(row: pd.Series):
    ...
    from app.low_price_bull_monitor_ui import add_stock_to_monitor_button
