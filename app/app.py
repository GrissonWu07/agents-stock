from app.console_utils import configure_standard_streams, install_safe_print
from app.runtime_paths import migrate_known_root_databases, migrate_known_root_logs

configure_standard_streams()
install_safe_print()
migrate_known_root_databases()
migrate_known_root_logs()
...
from app.streamlit_flash import queue_flash_message, render_flash_messages

from app.stock_data import StockDataFetcher
from app.ai_agents import StockAnalysisAgents
from app.pdf_generator import display_pdf_export_section
from app.database import db
from app.monitor_manager import display_monitor_manager, get_monitor_summary
...
from app.research_hub_ui import display_research_hub
from app.sector_strategy_ui import display_sector_strategy
from app.longhubang_ui import display_longhubang
from app.quant_sim.ui import display_quant_replay, display_quant_sim
from app.smart_monitor_ui import smart_monitor_ui
from app.news_flow_ui import display_news_flow_monitor
...
def main():
    ...
    if 'show_portfolio' in st.session_state and st.session_state.show_portfolio:
        from app.portfolio_ui import display_portfolio_manager
    ...
    if 'show_macro_analysis' in st.session_state and st.session_state.show_macro_analysis:
        from app.macro_analysis_ui import display_macro_analysis
        display_macro_analysis()
        return

    # 检查是否显示宏观周期分析
    if 'show_macro_cycle' in st.session_state and st.session_state.show_macro_cycle:
        from app.macro_cycle_ui import display_macro_cycle
        display_macro_cycle()
        return
